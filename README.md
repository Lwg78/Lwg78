...
| :--- | :--- | :--- |
| **[Memory Bear (Legacy Edge)](https://github.com/lwg78/memory-bear-legacy-edge)** | **🐻 Cognitive Agent.** A local AI agent running on a 2017 MacBook Air (Intel). Implements **Ebbinghaus Forgetting Curves** to dynamically manage context window limits. Features **Quantized Inference** and a biologically inspired **Memory Graph**. | Python, Llama.cpp, ChromaDB, NetworkX, Phi-3 |
